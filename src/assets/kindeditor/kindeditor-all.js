...
K.options = {
	...
	htmlTags : {
		...
		video : ['src','controls','class','source'],
	},
...
function _mediaImg(blankPath, attrs) {
	...
	if (attrs.src.indexOf(".mp4")!=-1) {
		var html = '<span>&nbsp;</span><video controls="controls" style="display:block;margin:0 auto;width:320px" class="' + _mediaClass(type) + '" ';
		html += '><source src="' + attrs.src + '" data-ke-src="'+attrs.src+'" >'
		html += '</video><span>&nbsp;</span>';
		return html;
	}
	else {
