    ...
    function($, api, cameraManagementList, projectManagementList, factoryManagementList,
        ...
        $('.kandao-aside .list-group').on('click', 'a', function() { // 点击侧边栏切换
            ...
            if ($(this).hasClass("mediaManagement")) { // 媒体资源管理
             ...
             else if ($(this).hasClass("productionVersionManagement")) { //    产品版本管理
                productionVersionManagementList(productionVersionManagementFlag);
        ...
        var  playListFlag = { flag1: true, flag2: true },
        ...
        function getClick(){                      
            ...
            $('.mediaLibrary').on('click', function() { //媒资下的媒体素材库
                mediaManagementList(headFlag);
            });
            $('.playList').on('click', function() { //媒资下的播放列表
                mediaPlayList(playListFlag);
            });
        ...
        function mapUrl(){ //url变化
            ...
            spaRouters.map('/media/mediaLibrary/info',function(transition){ //匹配媒体素详情
